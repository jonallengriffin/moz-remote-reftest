  ...
  _getTypeFromFile: function(file)
  {
    try
    {
      ...
      if (dot > 0)
      {
        ...
        for (var tmp in this._mimeMappings) {
        }
 ...
 * @param port
 *   the port on which the server will run, or -1 if there exists nolocalhost preference
...
function server(port, basePath)
{
  ...
  srv.registerContentType("list", "text/plain");
